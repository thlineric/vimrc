" =====================================================================
"
"  auto_complete.vim - setting auto_complete
"
" =====================================================================
"  EDIT HISTORY
"
...
" --- YouCompleteMe {
    ...
    "let g:ycm_global_ycm_extra_conf = expand(g:core.'/.ycm_extra_conf.py')
    ...
    " directly trigger auto-complete
    ...
    " auto trigger auto-completed by two words
    let g:ycm_semantic_triggers =  {
    ...
    " auto closed preview window when vim exit insert mode
